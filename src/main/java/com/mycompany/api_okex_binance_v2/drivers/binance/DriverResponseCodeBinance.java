...
public class DriverResponseCodeBinance {
    ...
    enum ResponseMessage {
        ...
        BINANCE_400("EX_BINANCE - КОД 400. Некорректный запрос - Неверный формат запроса"),
        BINANCE_403("EX_BINANCE - КОД 403. Был нарушен предел WAF (брандмауэр веб-приложений"),
        BINANCE_429("EX_BINANCE - КОД 429. Нарушение ограничения скорости запросов"),
        BINANCE_418("EX_BINANCE - КОД 418. IP-адрес был автоматически заблокирован для продолжения отправки запросов после получения 429 кодов"),
        BINANCE_500("EX_BINANCE - КОД 500. Внутренняя ошибка сервера - У нас возникли проблемы с нашим сервером");
